...
final class TablePagination extends JPanel {
    ...
    public TablePagination(TableModel tableModel) {
        ...
        if (tableModel.getTotalRowCount() > PAGE_SIZE_OPTIONS[0]) {
            ...
            JComboBox<String> pageSizeComboBox = new JComboBox<>(pageSizeLabels);
